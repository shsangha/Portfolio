  ...
  <>
    ...
    <h2 className="about_page_summary">
      <p className="about_page_summary_text">
        ...
        atque nostrum doloribus et dolore mollitia voluptas incidunt cupiditate
        soluta alias magni, assumenda fugiat veritatis itaque repellat in
        recusandae ipsam. Esse.
      </p>
    </h2>
    <h2 className="about_page_mission">
